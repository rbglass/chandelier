...
SingleJobPage.defaultProps = {
	tableScheme: [
		...
		{ key: "flex_length", display: "Flex",line2: "Length (m)", otherContent: "pdf", className: "qty-sm",       type: "text",   onChange: SharedActionCreators.changeItem},
		{ key: "bulb",        display: "Bulb",                otherContent: "pdf", className: "",                        type: "select",   onChange: SharedActionCreators.changeItem },
		{ key: "ceilingrose", display: "CeilingRose", 		  otherContent: "pdf", className: "ceilingroseMaxLength",			 type: "select",   onChange: SharedActionCreators.changeItem },
