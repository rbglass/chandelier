	...
	render() {
		...
		return (
			<div className="table-row table-header">
				<div className="table-row-item u-flex-grow2">Job #</div>
				...
				<div className="table-row-item u-flex-grow2">Order Type</div>
				<div className="table-row-item">Shipping Date</div>
